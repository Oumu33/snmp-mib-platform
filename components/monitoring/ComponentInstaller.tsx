...
export default function ComponentInstaller() {
    ...
    const steps: InstallationStep[] = [
      {
        ...
        status: 'pending',
        progress: 0,
        message: `正在连接到 ${selectedHost.hostname} (${selectedHost.ip})`
      },
      {
        id: 'download',
        title: '下载组件',
        status: 'pending',
        progress: 0,
        message: `下载 ${selectedComponent.name} v${selectedComponent.version}`
      },
      {
        id: 'install',
        title: '安装组件',
  ...
  const simulateInstallation = async (steps: InstallationStep[]) => {
    ...
    toast({
      title: "安装完成",
      description: `${selectedComponent?.name} 已成功安装到 ${selectedHost?.hostname}。`,
    });
      ...
      <Dialog open={showHostSelection} onOpenChange={setShowHostSelection}>
        <DialogContent className="max-w-4xl">
          <DialogHeader>
            ...
            <DialogDescription>
              选择要安装 {selectedComponent?.name} 的目标主机
            </DialogDescription>
          </DialogHeader>
                ...
                >
                  <CardContent className="p-4">
                    ...
                    <div className="grid grid-cols-3 gap-4 text-sm">
                      <div>
                        <p className="text-slate-500">规格</p>
                      ...
                      <div>
                        <p className="text-slate-500">存储</p>
      ...
      <Dialog open={showInstallProgress} onOpenChange={setShowInstallProgress}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              正在安装 {selectedComponent?.name} 到 {selectedHost?.hostname}
            </DialogDescription>
          </DialogHeader>
