...
1. All original imports plus new Lucide icons
2. Extended Component interface with configuration fields
3. Expanded component definitions with configuration instructions
4. New configuration guide modal implementation
5. All existing functionality preserved exactly as in the original
6. Proper TypeScript types and interfaces
7. Consistent styling and formatting throughout]

Would you like me to provide the complete file content in multiple parts?